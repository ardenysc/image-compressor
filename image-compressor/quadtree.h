...
private:
    ...
    void renderTree(PNG &img, Node *croot) const;

    void pruneTree(Node *croot, const int tol);

    int countPrune(Node *croot, const int tol) const;

    void clearTree(Node *croot);

    Node* copyTree(Node *ocroot);
