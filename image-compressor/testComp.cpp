...
TEST_CASE("qtcount::basic ctor render", "[weight=1][part=qtcount]") {
    ...
    out.writeToFile("images/out/render.png");
...
TEST_CASE("qtcount::basic idealPrune", "[weight=1][part=qtcount]") {
    ...
    qtcount t1(img);
    // cout<<"------count------"<<endl;
    // cout<<t1.idealPrune(1)<<endl;
    // cout<<t1.pruneSize(t1.idealPrune(1))<<endl;
    // cout<<t1.idealPrune(4)<<endl;
    // cout<<t1.pruneSize(t1.idealPrune(4))<<endl;
    // cout<<t1.idealPrune(6)<<endl;
    // cout<<t1.pruneSize(t1.idealPrune(6))<<endl;
    // cout<<t1.idealPrune(11)<<endl;
    // cout<<t1.pruneSize(t1.idealPrune(11))<<endl;
    // cout<<t1.idealPrune(20)<<endl;
    // cout<<t1.pruneSize(t1.idealPrune(20))<<endl;
...
TEST_CASE("qtvar::basic idealPrune", "[weight=1][part=qtvar]") {
    PNG img;
    img.readFromFile("images/orig/adasquare.png");
    // img.readFromFile("images/orig/smB.png");
